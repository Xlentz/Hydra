...
class HydraGame {
    ...
    centerGrid() {
        ...
        this.offsetY = (this.canvas.height - gridH) / 2 - 120; if(this.offsetY < 60) this.offsetY = 60; 
    }
    ...
    startLevel(index) {
        ...
        this.cellSize = Math.min((this.canvas.width - 20) / cols, (this.canvas.height - 240) / rows);
