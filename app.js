...
class HydraGame {
    ...
    drawGrid() {
        ...
        // 1. Spielfeldfliesen zeichnen (Hintergrundkästchen gut sichtbar machen)
        ...
        // 4. Rohre rendern (Mit geflicktem Fluss ohne Lücken)
        for (let r = 0; r < rows; r++) {
            for (let c = 0; c < cols; c++) {
                ...
                if (cell.type === 'WALL') {
                    ...
                    if (activeColors.length > 0 && (!this.isFlowing || this.flowAnimationProgress > 0)) {
                        let primaryColor = activeColors[0]; 
