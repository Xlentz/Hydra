const HYDRA_LEVELS = [
    {
        ...
        "walls": [],
        "inventory": {"pipes_straight": 4, "pipes_angle": 2, "pipes_cross": 0, "andGates": 0, "mixers": 0},
    ...
    },
    {
        ...
        "inventory": {"pipes_straight": 4, "pipes_angle": 4, "pipes_cross": 0, "andGates": 0, "mixers": 1},
        "hint": "Führe beide Farben in den Mixer."
    },
    {
        "id": 4, "title": "Getrennte Wege", "difficulty": "Mittel", "xpReward": 350,
        "gridSize": {"cols": 5, "rows": 5},
        "sources": [{"x": 0, "y": 1, "color": "red"}, {"x": 0, "y": 3, "color": "blue"}],
        "targets": [{"x": 4, "y": 3, "requiredColor": "red"}, {"x": 4, "y": 1, "requiredColor": "blue"}],
        "walls": [{"x": 2, "y": 0}, {"x": 2, "y": 4}, {"x": 1, "y": 2}, {"x": 3, "y": 2}],
        "inventory": {"pipes_straight": 6, "pipes_angle": 4, "pipes_cross": 1, "andGates": 0, "mixers": 0},
    ...
    },
    {
        ...
        "inventory": {"pipes_straight": 4, "pipes_angle": 4, "pipes_cross": 0, "andGates": 1, "mixers": 0},
